...
打开 http://localhost:5173/gpt-image-2.html、http://localhost:5173/gemini-image.html、http://localhost:5173/async-image.html 或 http://localhost:5173/seedance.html（端口占用时看终端提示）
...
| 操作 | 文件 |
| --- | --- |
| 改正文 | `docs/gpt-image-2.md`、`docs/gemini-image.md`、`docs/async-image.md`、`docs/seedance.md`（标准 Markdown） |
