...
打开 http://localhost:5173/gpt-image-2.html、http://localhost:5173/gemini-image.html 或 http://localhost:5173/async-image.html（端口占用时看终端提示）。`seedance.html` 尚未正式上线，默认不在侧栏展示。
